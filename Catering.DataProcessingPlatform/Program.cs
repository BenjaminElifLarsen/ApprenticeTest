...
using Catering.DataProcessingPlatform.AL.Handlers.ApiCommunication;
using Catering.DataProcessingPlatform.AL.Handlers.CustomerCommunication;
using Catering.DataProcessingPlatform.AL.Services.Contracts;
using Catering.DataProcessingPlatform.AL.Services.SeederService;
...
void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
{
    ...
    //Could call Process.Start("Catering.DataProcessingPlatform.exe") to start a new process 
