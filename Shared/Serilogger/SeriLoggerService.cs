...
public static class SeriLoggerService
{
    ...
    public static ILogger GenerateLogger(string key)
    {
        ...
        var config = new LoggerConfiguration()
            ...
            .WriteTo.Seq("http://localhost:5342", apiKey: key, controlLevelSwitch: levelSwitch); // Normally, it would write to the SEQ only in the case of no debugger is attached.
