...
public interface IBaseRepository<TEntity> where TEntity : class, IAggregateRoot
{
    ...
    public Task<IEnumerable<TMapping>> FindManyByPredicate<TMapping>(Func<TEntity, bool> predicate, BaseQuery<TEntity, TMapping> query) where TMapping : BaseReadModel;
